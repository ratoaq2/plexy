...
def test_get_title(values: typing.Mapping[str, str | None], expected: str | None) -> None:
    # given
...
def test_get_expected_languages(values: typing.Mapping[str, str | None], expected: list[str]) -> None:
    # given
    stream = mock(values, spec=plexapi.media.MediaPartStream)
